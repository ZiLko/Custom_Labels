...
bool TestmodeLabelSettings::setup() {
    ...
    auto btn = CCMenuItemSpriteExtra::create(
        btnSpr,
        this,
        menu_selector(TestmodeLabelSettings::saveSettings)
    );
    ...
    btn = CCMenuItemSpriteExtra::create(
        colorSprite,
        this,
        menu_selector(TestmodeLabelSettings::openColorPicker)
    );
    ...
    btn = CCMenuItemSpriteExtra::create(
        spr,
        this,
        menu_selector(TestmodeLabelSettings::switchPos)
    );
    btn->setID("right");
    ...
    btn = CCMenuItemSpriteExtra::create(
        spr,
        this,
        menu_selector(TestmodeLabelSettings::switchFont)
    );
    btn->setID("right");
    ...
    opacitySlider = Slider::create(
        this,
        menu_selector(TestmodeLabelSettings::updateOpacity),
        0.8f
    );
    ...
    sizeSlider = Slider::create(
        this,
        menu_selector(TestmodeLabelSettings::updateSize),
        0.8f
    );
    ...
    offsetXSlider = Slider::create(
        this,
        menu_selector(TestmodeLabelSettings::updateOffsetX),
        0.8f
    );
    ...
    offsetYSlider = Slider::create(
        this,
        menu_selector(TestmodeLabelSettings::updateOffsetY),
        0.8f
    );
...
TestmodeLabelSettings* TestmodeLabelSettings::create(int labelIndex) {
    auto ret = new TestmodeLabelSettings();
...
void TestmodeLabelSettings::switchFont(CCObject* obj) {
    auto id = static_cast<CCNode*>(obj)->getID();
    auto& lb = Labels::get();
...
void TestmodeLabelSettings::saveSettings(CCObject*) {
    keyBackClicked();
    auto& lb = Labels::get();
...
void TestmodeLabelSettings::openColorPicker(CCObject*) {
